package com.cagataysencan.template.data.local.dao

import androidx.room.Dao
import androidx.room.Insert
import androidx.room.OnConflictStrategy
import androidx.room.Query
import com.cagataysencan.template.data.local.entity.PostEntity
import kotlinx.coroutines.flow.Flow

/**
 * Room DAO for post cache operations. Access via [com.cagataysencan.template.data.local.database.DatabaseProvider].
 */
@Dao
interface PostDao {
